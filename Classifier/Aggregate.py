...
try:
	...
	print 'python Aggregate.py start(hrs) increment(hrs) end(hrs)'
	exit()
...
for filename in csvfiles:
	...
	for eachline in data:
		...
		flowdata.append(AggregateDlg.AggregateDlg(fields))
...
while starttime <= endtime:
	...
	outfile = open(AGGREGATESDIR + str(starttime) + '.csv', 'w')
